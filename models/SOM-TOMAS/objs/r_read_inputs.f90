...
!     ===================================================================================
      ...
      SUBROUTINE READ_INPUTS(nSOMCLASS, nSOMPRECS, iBINS, PATHi)
...
!     ===================================================================================
!     OPEN THE INPUT FILE: 
      OPEN(UNIT=30, FILE=TRIM(PATHi)//'/'//'in.vars', STATUS='OLD')
...
!     ===================================================================================
      OPEN(UNIT=30, FILE=TRIM(PATHi)//'/'//'in.PWL', STATUS='OLD')
      READ(30,*) kpar
      CLOSE(30)
...
!     ===================================================================================
      ...
      OPEN(UNIT=30, FILE=TRIM(PATHi)//'/'//'in.OH_PROFILE', STATUS='OLD')
      READ(30,*) i_OH_TS
      CLOSE(30)
...
!     ===================================================================================
      ...
      OPEN(UNIT=30, FILE=TRIM(PATHi)//'/'//'in.JNUC', STATUS='OLD')
      READ(30,*) i_JNUC_TS
      CLOSE(30)
